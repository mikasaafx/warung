...
<body>
	...
	<div class="container">
		...
		<div>
			<div class="row">
				<div class="col-md-12">
					<form action="add.php" method="post" name="form1" onsubmit="myFunction()">
								...
								<td>
									<select class="form-control" name="jenis_brg">
										...
										while ($barang = mysqli_fetch_array($array_jenis)) {
											echo "
												<option>".$barang['jenis_brg']."</option>
											";
										}
										 ?>
								</select>
...
<?php 
	if (isset($_POST['Submit'])) {
		...
		$insert = mysqli_query($mysqli, "INSERT INTO `barang`(`id`, `nama`, `jenis_brg`, `harga`, `stok`) VALUES ('', '$nama','$jenis_brg','$harga','$stok');");
